...
<TR>
<TD colSpan="4">
<SPAN style="FONT-SIZE: 9pt">3KBICAS대학교 복수전공 취소 및 부전공 전환 신청과 관련하여 아래와 같이 귀하의 개인정보를 수집·이용하
</SPAN>
</TD>
</TR>
<TR>
...
<SPAN style="FONT-SIZE: 9pt">3KBICAS대학교가 수집·이용할 개인정보 항목(필수항목) :
</SPAN>
</SPAN>
</P>
</TD>
...
<TD colSpan="2">
<P>
<SPAN style="FONT-SIZE: 9pt">3KBICAS대학교가 수집·이용할 개인정보 항목(선택항목) :
</SPAN>
</P>
</TD>
<TD>
